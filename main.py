...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'lovelshpandit9991406215@gmail.com' ")
...
message3 = tk.Label(window, text="Terii Face Recognition Attendance  System" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
head2 = tk.Label(frame2, text="                        New Registrations                       ", fg="blue",bg="#FFFFFF" ,font=('comic', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                        Already Registered                       ", fg="red",bg="#FFFFFF" ,font=('comic', 17, ' bold ') )
head1.place(x=0,y=0)
...
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy  ,fg="red"  ,bg="#FFFFFF"  ,width=35 ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
